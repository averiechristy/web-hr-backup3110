...
<form method="POST" action="{{ route('superadmin.tandem.process') }}" id="processForm">
    @csrf
...
<form method="GET" action="{{ route('superadmin.tandem.index') }}" class="mb-3 mt-4">
    ...
    <div class="col-md-4">
        <select name="filter_wilayah" class="form-select" onchange="this.form.submit()">
            <option value="">-- Semua Wilayahhh --</option>
...
<div class="modal fade" id="mundurkanStatusModal" tabindex="-1" aria-labelledby="mundurkanStatusModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="mundurkanStatusForm" method="POST" action="{{ route('superadmin.tandem.mundurkanStatus') }}">
          @csrf
