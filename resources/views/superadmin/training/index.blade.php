...
<form method="POST" action="{{ route('superadmin.training.process') }}" id="processForm">
    @csrf
    ...
    <div class="d-flex align-items-center mb-3">
        ...
        <select name="status" id="status" class="form-select me-2">
            ...
            <option value="Simpan Kandidat">Simpan Kandidat</option>
        </select>
...
<form method="GET" action="{{ route(name: 'superadmin.training.index') }}" class="mb-3 mt-4">
    <div class="row">
    <div class="col-md-4">
...
<div class="modal fade" id="mundurkanStatusModal" tabindex="-1" aria-labelledby="mundurkanStatusModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="mundurkanStatusForm" method="POST" action="{{ route('superadmin.training.mundurkanStatus') }}">
          @csrf
...
function processStatus() {
    ...
    checkboxes.forEach(function(checkbox) {
        ...
        checkedNames.push(checkbox.closest('tr').querySelector('td:nth-child(2) span').getAttribute('data-bs-original-title'));
    });
    ...
    // Update modal dengan daftar kandidat dan status
    document.getElementById('modalStatus').textContent = status;
    var kandidatList = document.getElementById('modalKandidatList');
