...
<form method="POST" action="{{ route('superadmin.psikotes.process') }}" id="processForm">
    @csrf
...
<form method="GET" action="{{ route('superadmin.psikotes.index') }}" class="mb-3 mt-4">
    <div class="row">
    <div class="col-md-4">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="mundurkanStatusForm" method="POST" action="{{ route('superadmin.psikotes.mundurkanStatus') }}">
          @csrf
