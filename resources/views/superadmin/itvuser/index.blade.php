...
<form method="POST" action="{{ route('superadmin.itvuser.process') }}" id="processForm">
    @csrf
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="mundurkanStatusForm" method="POST" action="{{ route('superadmin.itvhr.mundurkanStatus') }}">
          @csrf
